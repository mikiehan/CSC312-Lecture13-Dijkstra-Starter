package utils; /******************************************************************************
 *  Compilation:  javac lib.utils.In.java
 *  Execution:    java lib.utils.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from lib.utils.In to lib.StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from lib.utils.In to lib.StdIn.
   ...
   /**
    ...
    ////  begin: section (2 of 2) of code duplicated from lib.utils.In to lib.StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)lib.utils.In.readChar() error!"
   ...
   /**
    ...
    ///// end: section (2 of 2) of code duplicated from lib.utils.In to lib.StdIn */
   ...
   /**
     ...
     * @deprecated Replaced by {@code new lib.utils.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new lib.utils.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new lib.utils.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
   ...
   /**
     * Unit tests the {@code lib.utils.In} data type.
     *
